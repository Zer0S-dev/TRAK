...
// Transport HTTP POST générique via A7670.
// Le mutex transactionnel du modem est conservé pendant toute la transaction.
bool sendHttpPostCellular(const String& url,
                          const String& body,
                          uint32_t& bytesSent);
